...
Ohana uses [Codex](https://developers.openai.com/codex) in its own maintainer workflows —
automated PR review, issue triage, and a maintainer-triggered autofix — to cut the routine
load of maintaining the project. This document describes how those integrations are set up.
